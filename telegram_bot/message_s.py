...
# СООБЩЕНИЯ ОТ БОТА
start_message = "⚡️ Заработай вместе с нами ⚡️\n\n‼️ ТОЛЬЯТТИ | ЖИГУЛЁВСК‼️\n ‼️ СЫЗРАНЬ | ОКТЯБРЬСК ‼️\n\n|■ Конфиденциальность\n|■ Безопасность\n|■ Карьерный рост\n|■ Обучение, которое проводят профессионалы\n\n       ⁉️ Какая у тебя мечта ⁉️\n\n    💫  Расскажи её и исполни  💫\n   ✨  с магазином ANTIКRISIS  ✨\n\n       🪐Мы ждём именно тебя 🪐"
start_message_2 = "-  💎 Работа для каждого 💎\n   💵 ЗП от 100к в неделю 💵\n⚡️Не сиди на месте - действуй⚡️\n  ❗️ Пиши скорее оператору ❗️"
...
district_message = "- Район 🗺"
what_products_message = "- Продукт 🛒"
